...
if(isset($_POST['send']))
  {
    ...
    $query1=mysqli_query($con,"insert into  tblenquiry(CardId,FullName,Email,MobileNumber,Message,EnquiryNumber) value('$carid','$fullname','$email','$mobilenumber','$message','$enquirynumber')");
        //if ($query1) {
 echo '<script>alert("Your enquiry successfully send We contact you Shortely. Your Enquiry number is "+"'.$enquirynumber.'")</script>';
...
$mail->Body    = '<div style="background-color:white;border-radius:10px;padding:10px;"><h1>"your enquiry is succeccefully send. we will reply your enquiry as soon as possible.  Your Enquiry number is "+"'.$enquirynumber.'  Thank you for your Enquiry</h1>"</div>';
