...
if(isset($_POST['send']))
  {
    ...
    $query1=mysqli_query($con,"insert into  tblbooking(CardId,FullName,Email,MobileNumber,aadhar,BookingNumber) value('$carid','$fullname','$email','$mobilenumber','$aadhar','$bookingnumber')");
        //if ($query1) {
  echo '<script>alert("Your booking is successfull. We contact you Shortely. Your Booking number is "+"'.$bookingnumber.'")</script>';
  //echo "<script>window.location.href='car-list-book.php'</script>";
...
$mail->Body    = '<div style="background-color:white;border-radius:10px;padding:10px;"><h1>"your car booking is succecceful.  Your Booking number is '.$bookingnumber.'  Thank you for your Booking</h1>"</div>';
...
?>               
                  ...
                  <div class="widget section-sidebar bg-gray widget-selecr-contact" style="margin-top:3%">
                      <h3 class="widget-title bg-dark"><i class="ic icon_mail_alt"></i>Booking For Car</h3>
